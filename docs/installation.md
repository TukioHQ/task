...
```bash
go get -u -v github.com/TukioHQ/task/cmd/task
```

Installing in another directory:

```bash
git clone https://github.com/TukioHQ/task
cd task
...
[installscript]: https://github.com/TukioHQ/task/blob/master/install-task.sh
[releases]: https://github.com/TukioHQ/task/releases
